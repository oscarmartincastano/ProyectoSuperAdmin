    ...
    <div class="col-lg-12 m-b-10">
            ...
            <div class="p-t-15 p-b-15 p-l-20 p-r-20">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <a href="/manager/deportes/add" class="text-white btn btn-primary">Añadir nueva</a>
                            ...
                            <tbody>
                                @foreach ($deportes as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nombre }}</td>
                                        <td>
                                            <a href="/manager/deportes/{{ $item->id }}" class="btn btn-primary"><i class="far fa-edit"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
