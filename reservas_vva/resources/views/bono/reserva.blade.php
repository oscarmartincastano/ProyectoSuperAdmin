...
<body style="background:linear-gradient(0deg, rgba(36, 36, 36, 0.5), rgba(36, 36, 36, 0.5))@if (file_exists(public_path() . '/img/deportes/reserva-'. lcfirst($bono->deporte->nombre) .'.jpg')), url(/img/deportes/reserva-{{ lcfirst($bono->deporte->nombre) }}.jpg) @endif;
...
<div id="app">
    <section class="hero is-medium">
        <div class="has-text-centered title-div title-reserva-section" style="padding-top:4.5rem;padding-bottom:3.5rem;margin-bottom:0">
            <h1 class="title text-center mb-0">{{ $bono->nombre }}</h1>
        </div>
    </section>
    <main>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <h1><i class="far fa-calendar-check mr-2"></i> Contratar bono</h1>
                            ...
                            <p class="descripcion">
                                Esta contratando el bono de <em>{{$bono->nombre}}</em> Por favor, revise y confirme
                            ...
                            <form method="POST" @if (request()->slug_instalacion == 'la-guijarrosa') class="form-guijarrosa" @endif>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" name="precio_servicio" class="precio_servicio" value="{{$bono->precio}}">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label py-0">Precio:</label>
                                        <div class="col-sm-9">
                                            <div id="precio_total"  data-precio_base={{ $bono->precio }}><span>{{$bono->precio}}</span>€</div>
                                        </div>
                                    </div>
