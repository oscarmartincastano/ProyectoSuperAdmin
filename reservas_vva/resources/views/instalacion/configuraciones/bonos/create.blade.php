    ...
    <div class="row">
        <div class="col-lg-12 m-b-10">
            ...
            <div class="p-l-20 p-r-20 p-b-10 pt-3">
                <div>
                    <h3 class="text-primary no-margin">Añadir  bono</h3>
                </div>
            </div>
            ...
            <div class="p-t-15 p-b-15 p-l-20 p-r-20">
                <div class="card ">
                    <div class="card-header">
                        <div class="card-title">Nuevo bono</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('crear_bono',auth()->user()->instalacion->slug)}}" method="post" role="form" id="formulario">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label>Usos</label>
                                <input  name="usos" type="number" placeholder="Usos..." class="form-control" required>
                            </div>
