                ...
                <div class="col-sm-7 card-col-reserva">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="descripcion">
                                Esta contratando el servicio de <em>{{$servicio->nombre}}</em> Por favor, revise y confirme
                                los datos siguientes.
                            </p>

                            <form method="POST" action="#" @if (request()->slug_instalacion == 'la-guijarrosa') class="form-guijarrosa" @endif>
                                @csrf
                                @if (request()->slug_instalacion == 'la-guijarrosa')
                                    <div class="border p-3 mb-3">
                                        ...
                                        <div class="autorizacion d-none">
                                            ...
                                            <input type="checkbox" name="terminos_edad" id="terminos_edad" class="mt-3"> Si marcas esta casilla confirmas que aceptas los términos de este <a class="documento_enlace" href="{{ asset('docs/Autorización utilización gimnasio menores de 16 años.docx') }}" target="_blank">documento</a>, y te comprometes a entregarlo firmado y rellenado en formato papel en la instalación.
                                        </div>
