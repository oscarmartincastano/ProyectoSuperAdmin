...
Route::post('/logout-manager', [AuthenticatedSessionController::class, 'destroymanager'])->name('logout.manager');
...
Route::prefix('superadmin')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/get-instalaciones', [SuperAdminController::class, 'getInstalaciones'])->name('superadmin.getInstalaciones');
    });

    Route::get('/', [SuperAdminController::class, 'index'])->name('superadmin.index');
    Route::get('/{id}/edit', [SuperAdminController::class, 'edit'])->name('superadmin.edit');
    Route::get('/{id}/edit-users', [SuperAdminController::class, 'editUsers'])->name('superadmin.editUsers');
    Route::put('/{id}/edit-users/{userId}', [SuperAdminController::class, 'updateUserRole'])->name('superadmin.updateUserRole');
    Route::delete('/{id}/edit-users/{userId}', [SuperAdminController::class, 'deleteUser'])->name('superadmin.deleteUser');
