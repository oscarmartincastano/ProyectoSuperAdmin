...
public function update(Request $request, $id)
{
    ...
    // Actualizar las instalaciones en la conexión secundaria
    ...
    // Ejemplo de actualización en la conexión 'superadmin'
    $superadminConnection->table('users')->where('id', 1)->update([
        'name' => 'Nuevo Nombre',
    ]);
